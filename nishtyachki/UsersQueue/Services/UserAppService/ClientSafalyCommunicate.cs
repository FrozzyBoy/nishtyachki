...
{
    public class ClientSafalyCommunicate : IUserAppServiceClient
    {
        private IUserAppServiceClient _client;
        ...
        public ClientSafalyCommunicate(IUserAppServiceClient client)
        {
            _client = client;
            log.Info("test");
        }
